...
public class CanvasComponent extends JComponent {
    ...
    /**
     * This overridden method traverses the list of shapes to make sure that all shapes are drawn
     */
    ...
    /**
     * Establish the appropriate starting point as given to us by the caller. then, the shaoe
    ...
    {
        shapes.add(new Line(startPoint, p, currentColor)); //anonymous object. .add() appends to list
    }
